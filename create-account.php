...
<div class="container">
	...
	echo "<div class='alert alert-warning mt-4' role='alert'>
					...
					<p><a href='index'>Por favor ingrese aqui</a></p>
				</div>";
	} else {
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		echo "<div class='alert alert-success mt-4' role='alert'><h3>Su cuenta ha sido creada con exito.</h3>
		<a class='btn btn-outline-primary' href='index' role='button'>Ingresar</a></div>";
		} else {
